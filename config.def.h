...
static const char *fonts[]          = { "monospace:style:bold:size:16" };
...
static const char *const autostart[] = {
	...
	"picom", "-b", NULL,
	"nm-applet", NULL,
	"sh", "-c", "conky -c ~/.config/conky/dwm/nord.conkyrc", NULL,
	"sh", "-c", "feh --randomize --bg-fill ~/Pictures/wall/*", NULL,
    "sh", "display_setup.sh", NULL,
	NULL /* terminate */
};
...
static const Rule rules[] = {
	...
	{ "thorium-browser",    NULL,       	NULL,       1 << 8,     	0,		        0,              -1 },
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,                 XK_u,       setborderpx,    {.i = +1 } },
